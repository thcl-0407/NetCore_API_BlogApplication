...
namespace UnitTest_Services_BlogApplication.UnitTest_CommentService
{
    [TestClass]
    public class UnitTest_RemoveComment_CommentService
    {
        ...
        public UnitTest_RemoveComment_CommentService()
        {
            ...
            PostTest = new Post();
            PostTest.TitlePost = "Title";
            PostTest.SummaryPost = "Summary";
            PostTest.ContentPost = "Content";
            PostTest.DateCreate = DateTime.Now;
            PostTest.DateUpdate = DateTime.Now;
            PostTest.ImageID = ImageGalleryTest.ImageID;
            PostTest.UserID = UserTest.UserID;

            db.Posts.Add(PostTest);
            db.SaveChanges();

            PostTest = db.Posts.First();
        }

        #region Test UserId Null
        [TestMethod]
        public void RemoveComment_UserIDNull_ActualFalse()
        {
            //Arrange
            string UserID = null;
        ...
        #region Test Comment ID Null
        [TestMethod]
        public void RemoveComment_CommentIDNull_ActualFalse()
        {
            //Arrange
        ...
        [TestMethod]
        public void RemoveComment_UserIDEmpty_ActualFalse()
        {
            //Arrange
            string UserID = " ";
            string CommentID = Guid.NewGuid().ToString();
        ...
        #region Test Comment ID Empty
        [TestMethod]
        public void RemoveComment_CommentIDEmpty_ActualFalse()
        {
            //Arrange
            string UserID = Guid.NewGuid().ToString();
            string CommentID = " ";
        ...
        #region Test Comment ID Not Exist
        [TestMethod]
        public void RemoveComment_CommentIDNotExist_ActualFalse()
        {
            //Arrange
            string UserID = Guid.NewGuid().ToString();
            string CommentID = Guid.NewGuid().ToString();
        ...
        #region Test User ID Not Exist
        [TestMethod]
        public void RemoveComment_UserIDNotExist_ActualFalse()
        {
            //Arrange
            string UserID = Guid.NewGuid().ToString();
            string CommentID = Guid.NewGuid().ToString();
        ...
        #region Test User ID Exist But Not Owner's Post
        [TestMethod]
        ...
        #region Test Success
        [TestMethod]
        public void RemoveComment_Success_ActualTrue()
        {
            //Arrange
            db.PostComments.RemoveRange(db.PostComments);
            db.Comments.RemoveRange(db.Comments);
