...
{
    [TestClass]
    public class UnitTest_UpdatePost_PostService
    {
        ...
        public UnitTest_UpdatePost_PostService()
        {
            ...
            UserTest.UserName = "Test Post";
            UserTest.Email = "thcongloc@icloud.com";
        ...
        [TestMethod]
        public void UpdatePost_UserIDNull_ActualFalse()
        {
            //Arrange
            string UserID = null;
        ...
        #region Test PostWriteDTO Title Null
        [TestMethod]
        public void UpdatePost_PostWriteDTOTitleNull_ActualFalse()
        {
            //Arrange
            string UserID = Guid.NewGuid().ToString();
            PostWriteDTO postWriteDTO = new PostWriteDTO
        ...
        #region Test PostWriteDTO Summary Null
        [TestMethod]
        public void UpdatePost_PostWriteDTOSummaryNull_ActualFalse()
        {
            //Arrange
            string UserID = Guid.NewGuid().ToString();
            PostWriteDTO postWriteDTO = new PostWriteDTO
        ...
        #region Test PostWriteDTO Content Null
        [TestMethod]
        public void UpdatePost_PostWriteDTOContentNull_ActualFalse()
        {
            //Arrange
            string UserID = Guid.NewGuid().ToString();
            PostWriteDTO postWriteDTO = new PostWriteDTO
        ...
        #region Test PostWriteDTO Title is Empty
        [TestMethod]
        public void UpdatePost_PostWriteDTOTitleEmpty_ActualFalse()
        {
            //Arrange
            string UserID = Guid.NewGuid().ToString();
            PostWriteDTO postWriteDTO = new PostWriteDTO
        ...
        #region Test PostWriteDTO Summary Empty
        [TestMethod]
        public void UpdatePost_PostWriteDTOSummaryEmpty_ActualFalse()
        {
            //Arrange
            string UserID = Guid.NewGuid().ToString();
            PostWriteDTO postWriteDTO = new PostWriteDTO
        ...
        #region Test PostWriteDTO Content Empty
        [TestMethod]
        public void UpdatePost_PostWriteDTOContentEmpty_ActualFalse()
        {
            //Arrange
            string UserID = Guid.NewGuid().ToString();
            PostWriteDTO postWriteDTO = new PostWriteDTO
        ...
        #region Test Post Not Exist
        [TestMethod]
        public void UpdatePost_PostNotExist_ActualFalse()
        {
            //Arrange
            string UserID = Guid.NewGuid().ToString();
            PostWriteDTO postWriteDTO = new PostWriteDTO
        ...
        #region Test User Exists Have Update Image
        [TestMethod]
        public void UpdatePost_UserNotExistHaveUpdateImage_ActualTrue()
        {
            //Arrange
            db.Posts.RemoveRange(db.Posts);
            db.SaveChanges();
        ...
        #region Test User Exists Not Update Image
        [TestMethod]
